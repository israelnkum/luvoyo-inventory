...
function TerminationReasons (props) {
    const { setPageInfo, setExtra } = useOutletContext();
    useEffect(() => {
        setPageInfo({ title: 'Termination Reasons', addLink: '/pim/add', buttonText: 'Reason' })
    }, [])
...
TerminationReasons.propTypes = {
    pageInfo: PropTypes.object,
}

export default connect()(TerminationReasons)
